classdef aten__dropout8 < nnet.layer.Layer & nnet.layer.Formattable
    %aten__dropout8 Auto-generated custom layer
    ...
    methods
        function obj = aten__dropout8(Name, Type, InputNames, OutputNames)
            obj.Name = Name;
            obj.Type = Type;
            obj.NumInputs = 2;
            obj.NumOutputs = 2;
